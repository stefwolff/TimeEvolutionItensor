...
LIBRARY_DIR=$(HOME)/itensor_clone/itensor
...
$(APP): $(OBJECTS) $(ITENSOR_LIBS) 
	$(CCCOM)  $(CCFLAGS) $(OBJECTS) -o $(APP) $(LIBFLAGS) #-Wno-literal-suffix 

$(APP)-g: mkdebugdir $(GOBJECTS) $(ITENSOR_GLIBS)
	$(CCCOM) $(CCGFLAGS) $(GOBJECTS) -o $(APP)-g $(LIBGFLAGS) #-Wno-literal-suffix
